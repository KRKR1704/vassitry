"""
Phase 6B voice smoke test: simulate STT result routed through InputRouter.
Run with: python tests/test_ui_voice_smoke.py
...
def main():
    ...
    # simulate STT result after 200ms: InputRouter should echo+submit when echo=True
    def simulate_voice():
        try:
            ...
            print("Failed to invoke voice simulation:", e)

    QTimer.singleShot(200, simulate_voice)
    ...
    print("Voice smoke finished, ok=", ok, "exit_rc=", rc)
